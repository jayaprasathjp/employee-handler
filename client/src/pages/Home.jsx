    ...
    <div className=" bg-right bg-cover"> 
      <div className="w-full container  p-6">
        <div className="w-full flex items-center justify-center ">
          <a className="flex items-center text-cyan-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
            {/* <Vector/> */}
            HRMS TOOL
          </a>
      ...
      <div className=" container pt-10 md:pt-10 px-6 flex-wrap flex-col md:flex-row">
        <div className="flex text-center justify-center  flex-col w-full   overflow-y-hidden">
          <h1 className="my-4 text-2xl md:text-4xl text-cyan-800 font-bold leading-tight  ">
Optimize HR with smart automation.</h1>
          <p className=" leading-normal text-base md:text-lg mb-8 text-slate-500">Effortlessly manage your workforce with precision and ease. Discover our HRMS tool—your ultimate solution for optimizing employee productivity and simplifying HR tasks!</p>
